...
//SDL_GL_SwapWindow(SDL_MOAI_WINDOW);   //swap
...
//float start_time = SDL_GetTicks(); 
    ...
    MOAIUrlMgrNaCl::Get ().Process ();
               ...
               this->mTaskSubscriber->Publish (); //MOAI 1.4p
...
while (  loopA < 1  ) { 
                          ...
                          //  __android_log_print(ANDROID_LOG_INFO, "C++", "LOOP 1 is %d", myInt);  
                 ...
                 //  while (  loopB < 1  ) {   
                                             ...
                                             //   __android_log_print(ANDROID_LOG_INFO, "C++", "DEAD 2 is %s", "sim");
                                                               

                                                                       //  __android_log_print(ANDROID_LOG_INFO, "C++", "DEAD 1 is %s", "sim");
...
step = this->mDeviceTime - this->mTime - this->mStep * 2; 

if( step > this->mStep ) { STEP_LOOP_IMPL (); }
...
//this->mDataIOThread.Publish (); //MOAI 1.3      	  
//MOAIMainThreadTaskSubscriber::Get ().Publish (); //MOAI 1.4 >


              //   if((1000/59)>(SDL_GetTicks()-start_time))
             //   {
             //           
               //           SDL_Delay((1000/59)-(SDL_GetTicks()-start_time)); //Yay stable framerate!
             //   };
